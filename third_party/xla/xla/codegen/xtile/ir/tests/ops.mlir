...
xtile.entry_func @with_attributes(
  ...
  %tile_id: index) attributes {xtile.tile_info = #xtile.tile_info<count:1>} {
  xtile.return
}
...
func.func @incorrect_offset_count_extract(%arg: memref<1024xf32>) -> tensor<10xf32> {
  ...
  %tile = xtile.extract %arg[%offset, %offset][10, 1][1, 1] : memref<1024xf32> -> tensor<10xf32>
...
func.func @incorrect_offset_count_insert(%src: tensor<24xf32>, %dst: memref<1024xf32>) {
  ...
  xtile.insert %src into %dst[%offset, %offset][24, 1][1, 1] : tensor<24xf32> -> memref<1024xf32>
  return
}
